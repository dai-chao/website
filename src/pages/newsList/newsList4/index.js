        ...
        return(
            <div className="news4Box">
                ...
                <div id="fourNews" className="news-box">
                    <h1>银河保险·国龄·中汇祥龄三方正式签约成战略合作伙伴</h1>
                    <p className="pushtime">发布时间：<span>2019-06-24</span></p>
                    <div><img src={four1} alt="新闻详情图"/></div>
                    <div><img src={four2} alt="新闻详情图"/></div>
                    ...
                    <div><img src={four3} alt="新闻详情图"/></div>
                    <p className="introBott">
                    ...
                    <div><img src={four4} alt="新闻详情图"/></div>
                    <p className="introBott">
                    ...
                    <div><img src={four7} alt="新闻详情图"/></div>
                    <p className="introBott">
                    ...
                    <div><img src={four8} alt="新闻详情图"/></div>
                    <p className="introBott">
                    ...
                    <div><img src={four9} alt="新闻详情图"/></div>
                    <p className="introBott"></p>
                </div>
                <Footer/>
            </div>
        )
