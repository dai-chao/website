        ...
        return(
            <div className="news2Box">
                ...
                <div id="towNews" className="news-box">
                    <h1>中国老龄协会领导莅临中汇祥龄公司考察调研!</h1>
                    <p className="pushtime">发布时间：<span>2019-04-16</span></p>
                    <div><img src={newst1} alt="新闻详情图"/></div>
                    ...
                    <div><img src={newst2} alt="新闻详情图"/></div>
                    <p className="introBott">
                        ▲ 中国老龄协会老年人才信息中心总工程师 李强 发言
                    </p>
                    <div><img src={newst3} alt="新闻详情图"/></div>
                    <p className="introBott">
                        ▲ 中国老龄协会老年人才信息中心专家委员会秘书长、北京国龄智慧健康养老产业发展中心主任 成克庸 发言
                    </p>
                    <div><img src={newst4} alt="新闻详情图"/></div>
                    <p className="introBott">
                        ▲ 中汇祥龄公司领导班子在亓玉刚董事长带领下做集体汇报。
                    </p>
                    <div><img src={newst5} alt="新闻详情图"/></div>
                    <p className="introBott">
                        中航集团进入新时代实现新作为
                    </p>
                </div>
