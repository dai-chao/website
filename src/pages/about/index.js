    ...
    render(){
        return(
            <div className="aboutBox">
                ...
                <h2 className="ab">- 合作机构 -</h2>
                <ul className="aboutList">
                    <li className="lian">全国老龄工作委员会办公室信息中心</li>
                    <li className="lian">北京国龄智慧健康养老产业发展中心</li>
                    <li className="lian">银河保险经纪（北京）有限责任公司</li>
                    <li className="lian">安邦保险集团股份有限公司</li>
                </ul>
                <Footer/>
            </div>
        )
